...
test.describe('Product Details Page Tests', () => {
  ...
  test('should display selected product image correctly', async ({ page }) => {
  ...
  test('adding select product should display a notification', async ({ page }) => {
  ...
  test('should navigate to a similar product details page', async ({ page }) => {
